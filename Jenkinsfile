...
podTemplate(
    ...
    node(POD_LABEL) {
	  ...
	  sh 'echo "FROM centos \n RUN yum update -y && yum install -y wget && yum install -y unzip && wget https://binaries.sonarsource.com/Distribution/sonar-scanner-cli/sonar-scanner-cli-4.0.0.1744-linux.zip && cd / && cd  && mkdir /home/sonarqube/ && unzip -o sonar-scanner-cli-4.0.0.1744-linux.zip -d /home/sonarqube/sonar-scanner-cli-4.0.0.1744-linux" > Dockerfile'		/*Build docker*/
