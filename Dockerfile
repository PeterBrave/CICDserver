...
CMD ["/usr/share/tomcat/apache-tomcat-8.5.43/bin/shutdown.sh"] && ["/usr/share/tomcat/apache-tomcat-8.5.43/bin/catalina.sh", "run"] &&  ["/usr/share/tomcat/apache-tomcat-8.5.43/bin/startup.sh"]
